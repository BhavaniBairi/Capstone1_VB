...
def get_video_details(videos_ids_info):
    list_video_details = []
...
def Youtube_Data(channel_id):
    ...
    return "Stored in MongoDB successfully"
...
def channel_table():
    ...
    drop_table_channels = '''drop table if exists channels'''
    mycursor.execute(drop_table_channels)
    mydb.commit()
    ...
    try:
        ...
        mydb.commit()
            ...
            print("Channel's table is already created")
    ...
    for index,row in df.iterrows():
        ...
        try:
            ...
            print("Channel information is already present")
...
def videos_table():
    ...
    drop_table_video = '''drop table if exists videosinfo'''
    mycursor.execute(drop_table_video)
    mydb.commit()
    ...
    try:
        ...
        print("videosinfo table is already created")
    ...
    for index,row in df1.iterrows():
        ...
        try:
            ...
            print("Video information is already present")
...
def playlists_table():
    ...
    drop_table_playlist = '''drop table if exists playlists'''
    mycursor.execute(drop_table_playlist)
    mydb.commit()
    ...
    for index,row in df2.iterrows():
        ...
        try:
            ...
            print("Playlists details already inserted in SQL")
...
def comments_table():
    ...
    drop_table_comment = '''drop table if exists comments'''
    mycursor.execute(drop_table_comment)
    mydb.commit()
...
with st.container():
    ...
    st.caption("Data collection using youtube API")
    st.caption("MongoDB")
...
with col1:
    ...
    if st.button("Store data in MongoDB"):
        ...
        if channel_id in channel_ids:
            st.success("Channel information of this id already exists. Please enter different id .")
